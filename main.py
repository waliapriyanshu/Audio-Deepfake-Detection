...
from evaluation import produce_evaluation_file
from losses import AMSoftmaxLoss
...
def train_epoch(
    ...
    # Use AM-Softmax loss instead of weighted cross-entropy
    criterion = AMSoftmaxLoss(s=30.0, m=0.4)
